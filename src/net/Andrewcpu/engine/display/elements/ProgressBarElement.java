 ...
 */
public class ProgressBarElement extends Element implements Renderable {
    private int width, height;
    private double value = 0;
    private Color background = Color.WHITE, foreground = Color.GREEN;
    public ProgressBarElement(int x, int y, int width, int height) {
        setX(x);
        setY(y);
        this.width = width;
        this.height = height;
    ...
    public void draw(Graphics g) {
        ...
        g.fillRect(getX(),getY(),(int)d,getHeight());
    }
}
